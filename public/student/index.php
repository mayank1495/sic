                    ...
                    <div class="row">
                        ...
                        <div class="col-1-of-2">
                            <div class="form__group">
                                ...
                                <input type="text" class="form__input" disabled value="" id="citycol" name="citycol">
                            </div>
                            <div class="form__group">
                            ...
                            <div class="form__group">
                                ...
                                <input type="text" class="form__input" disabled value="" id="gn" name="gn">
                            </div>
                            <!-- <div class="form__group">
                                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-1-of-2">
                            ...
                            <div class="form__group">
                                ...
                                <input type="text" class="form__input_med" disabled value="" id="club" name="club">
                            </div>
                            <div class="form__group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-1-of-2">
                                ...
                                <div class="form__group">
                                    ...
                                    <input type="text" class="form__input" disabled value="" id="sccit12" name="sccit12">
                                </div>
                                <div class="form__group">

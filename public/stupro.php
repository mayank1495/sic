                        ...
                        <div class="row">
                            ...
                            <div class="col-1-of-2">
                                <div class="form__group">
                                    ...
                                    <input type="text" onblur="checkString(this);" onkeyup="checkString(this);" class="form__input" value="First Name" id="namef" name="namef"  disabled>
                               </div>
                                <div class="form__group">
                                    <label for="namel" class="form__label">Last Name</label>
                                    <input type="text" class="form__input" onblur="checkString(this);" onkeyup="checkString(this);" disabled value="" id="namel" name="namel" >
                                </div>
                                ...
                                <div class="form__group">
                                    ...
                                    <div class="row">
                                        <div class="col-1-of-2">  
                                            <input type="text" class="form__input_small" disabled value="" id="email" name="email"  onblur="checkEmail(this);" onkeyup="checkEmail(this);">
                                        </div>
                                        <div class="col-1-of-2">
                                            <input type="text" class="form__input_small" disabled value="" name="emaildom" >
                                        </div>
                                    </div>
                                </div>
                                <div class="form__group">
                                    <label for="add" class="form__label">Address</label>
                                    <input type="text" class="form__input_big" disabled value="" id="add" name="addr" >
                                </div>
                            </div>
                            <div class="col-1-of-2">
                                <div class="form__group">
                                    <label for="citycol" class="form__label">City</label>
                                    <input type="text" class="form__input" onblur="checkString(this);" onkeyup="checkString(this);" disabled value="" id="citycol" name="citycol" >
                                </div>
                                <div class="form__group">
                                ...
                                <div class="form__group">
                                    ...
                                    <input type="text" class="form__input" disabled value="" id="tel" name="tel" min="1000000000" max="9999999999" onblur="checkPhone(this);" onkeyup="checkPhone(this);" >
                                </div>
                                <div class="form__group">
                                    <label for="telalt" class="form__label">Alternate Phone No.</label>
                                    <input type="text" class="form__input" disabled value="" id="telalt" name="telalt" min="1000000000" max="9999999999" onblur="checkPhone(this);" onkeyup="checkPhone(this);"  >
                                </div>
                                <br>
                                <div class="form__group">
                                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-1-of-2">
                                <div class="form__group">
                                    ...
                                    <input type="text" class="form__input" disabled value="" id="reg" name="reg" step="1" min="20140000" max="20179990" >
                                </div>
                                <div class="form__group">
                                ...
                                <div class="form__group">
                                    ...
                                    <div class="row">
                                        <div class="col-1-of-3">
                                            <input type="text" class="form__input_small" disabled value="" id="rollyr" name="rollyr" step="1" min="14" max="17" >
                                        </div>
                                        <div class="col-1-of-3">
                                            <input type="text" class="form__input_small" disabled value="" name="rolld" >
                                        </div>
                                        <div class="col-1-of-3">
                                            <input type="text" class="form__input_small" disabled value="" id="rolln" name="rolln" step="1" min="1" max="150" >        
                                        </div>
                                    </div>
                                </div>
                                <div class="form__group">
                                    <label for="sem" class="form__label">Semester</label>
                                    <input type="text" class="form__input" disabled value="" id="sem" name="sem" step="1.0" min="1" max="8.0"  >
                                    <!-- onblur="disSg(this);" -->
                                </div>
                                <div class="form__group">
                                    <label for="cg" class="form__label">CGPA</label>
                                    <input type="text" class="form__input" disabled value="" id="cg" name="cg" step="0.1" min="1" max="10.0" >
                                </div>
                                <div class="form__group">
                                    <label for="sg1" class="form__label">SGPA SEM 1</label>
                                    <input type="text" class="form__input" disabled value="" id="sg1" name="sg1" step="0.1" min="1" max="10.0" >
                                </div>
                                <div class="form__group">
                                    <label for="sg2" class="form__label">SGPA SEM 2</label>
                                    <input type="text" class="form__input" disabled value="" id="sg2" name="sg2" step="0.1" min="1" max="10.0" >
                                </div>
                                <div class="form__group">
                                    <label for="sg3" class="form__label">SGPA SEM 3</label>
                                    <input type="text" class="form__input" disabled value="" id="sg3" name="sg3" step="0.1" min="1" max="10.0" >
                                </div>
                                <div class="form__group">
                                    <label for="sg4" class="form__label">SGPA SEM 4</label>
                                    <input type="text" class="form__input" disabled value="" id="sg4" name="sg4" step="0.1" min="1" max="10.0" >
                                </div>
                                <div class="form__group">
                                    <label for="sg5" class="form__label">SGPA SEM 5</label>
                                    <input type="text" class="form__input" disabled value="" id="sg5" name="sg5" step="0.1" min="1" max="10.0" >
                                </div>
                                <div class="form__group">
                                    <label for="sg6" class="form__label">SGPA SEM 6</label>
                                    <input type="text" class="form__input" disabled value="" id="sg6" name="sg6" step="0.1" min="1" max="10.0" >
                                </div>
                                <div class="form__group">
                                    <label for="sg7" class="form__label">SGPA SEM 7</label>
                                    <input type="text" class="form__input" disabled value="" id="sg7" name="sg7" step="0.1" min="1" max="10.0" >
                                </div>
                                <div class="form__group">
                                    <label for="sg8" class="form__label">SGPA SEM 8</label>
                                    <input type="text" class="form__input" disabled value="" id="sg8" name="sg8" step="0.1" min="1" max="10.0" >
                                </div>
                            </div>
                            <div class="col-1-of-2">
                                <div class="form__group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-1-of-2">
                                    ...
                                    <div class="form__group">
                                        ...
                                        <input type="text" class="form__input" disabled value="" id="sccit12" onblur="checkString(this);" onkeyup="checkString(this);" name="sccit12" >
                                    </div>
                                    <div class="form__group">
                                ...
                                <div class="col-1-of-2">
                                    ...
                                    <div class="form__group">
                                        ...
                                        <input type="text" class="form__input" disabled value="" id="mar12" name="mar12" step="0.01" min="0" max="100" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-1-of-2">
                                    ...
                                    <div class="form__group">
                                        ...
                                        <input type="text" class="form__input" disabled value="" id="sccit11" name="sccit11" onblur="checkString(this);" onkeyup="checkString(this);" >
                                    </div>
                                    <div class="form__group">
                                ...
                                <div class="col-1-of-2">
                                    ...
                                    <div class="form__group">
                                        ...
                                        <input type="text" class="form__input" disabled value="" id="mar11" name="mar11" step="0.01" min="0" max="100" >
                                    </div>
                                </div>
                            </div>
                        <!-- <div class="row sbmt">
